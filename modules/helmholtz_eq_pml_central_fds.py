    ...
    for k in range(nk):
        ...
        if k in puntos:
            if (i == 0 or i == nx-1 or j == 0 or j == ny-1):
                ...
                cA = - 2/(delx**2)*tA(i, j, 1, 1) - 2/(dely**2)*tB(i, j, 1, 1) + tC(i, j, 1, 1)
                cB = - 1/(4*delx**2)*tA(i-1, j, 1, 1) + 1/(delx**2)*tA(i, j, 1, 1) + 1/(4*delx**2)*tA(i+1, j, 1, 1)
                cC =   1/(4*delx**2)*tA(i-1, j, 1, 1) + 1/(delx**2)*tA(i, j, 1, 1) - 1/(4*delx**2)*tA(i+1, j, 1, 1)
                cD = - 1/(4*dely**2)*tB(i, j-1, 1, 1) + 1/(dely**2)*tB(i, j, 1, 1) + 1/(4*dely**2)*tB(i, j+1, 1, 1)
                cE =   1/(4*dely**2)*tB(i, j-1, 1, 1) + 1/(dely**2)*tB(i, j, 1, 1) - 1/(4*dely**2)*tB(i, j+1, 1, 1)

            elif ((i<nbl) or (i>nx-nbl-1)):
                cA = - 2/(delx**2)*tA(i, j, 1, 0) - 2/(dely**2)*tB(i, j, 1, 0) + tC(i, j, 1, 0)
                cB = - 1/(4*delx**2)*tA(i-1, j, 1, 0) + 1/(delx**2)*tA(i, j, 1, 0) + 1/(4*delx**2)*tA(i+1, j, 1, 0)
                cC =   1/(4*delx**2)*tA(i-1, j, 1, 0) + 1/(delx**2)*tA(i, j, 1, 0) - 1/(4*delx**2)*tA(i+1, j, 1, 0)
                cD = - 1/(4*dely**2)*tB(i, j-1, 1, 0) + 1/(dely**2)*tB(i, j, 1, 0) + 1/(4*dely**2)*tB(i, j+1, 1, 0)
                cE =   1/(4*dely**2)*tB(i, j-1, 1, 0) + 1/(dely**2)*tB(i, j, 1, 0) - 1/(4*dely**2)*tB(i, j+1, 1, 0)

            elif ((j<nbl) or (j>ny-nbl-1)):
                cA = - 2/(delx**2)*tA(i, j, 0, 1) - 2/(dely**2)*tB(i, j, 0, 1) + tC(i, j, 0, 1)
                cB = - 1/(4*delx**2)*tA(i-1, j, 0, 1) + 1/(delx**2)*tA(i, j, 0, 1) + 1/(4*delx**2)*tA(i+1, j, 0, 1)
                cC =   1/(4*delx**2)*tA(i-1, j, 0, 1) + 1/(delx**2)*tA(i, j, 0, 1) - 1/(4*delx**2)*tA(i+1, j, 0, 1)
                cD = - 1/(4*dely**2)*tB(i, j-1, 0, 1) + 1/(dely**2)*tB(i, j, 0, 1) + 1/(4*dely**2)*tB(i, j+1, 0, 1)
                cE =   1/(4*dely**2)*tB(i, j-1, 0, 1) + 1/(dely**2)*tB(i, j, 0, 1) - 1/(4*dely**2)*tB(i, j+1, 0, 1)
